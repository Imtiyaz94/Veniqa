  ...
  async getAllAdmins() {
    ...
    try {
      let users = await User.find(
        {},
        '-_id email name permissions approved',
      ).exec();
      if (!users) {
        result = {
          httpStatus: httpStatus.OK,
          status: 'No Admin Found',
          responseData: users,
        };
        return;
      }
    ...
    try {
      ...
      result = user
        ...
        : {
            ...
            status: 'failed',
            errorDetails: httpStatus.getStatusText(httpStatus.NOT_FOUND),
          };
      return result;
    } catch (err) {
    ...
    try {
      ...
      if (!email) {
        result = {
          httpStatus: httpStatus.BAD_REQUEST,
          status: 'failed',
          errorDetails: 'Missing Admin email',
        };
        return result;
      }
    ...
    try {
      ...
      result = user
        ...
        : {
            ...
            status: 'failed',
            errorDetails: httpStatus.getStatusText(
